...
import { Box, Wrench, Hammer, Factory, CircleDashed, Cpu, PenTool, Layers, ChevronRight, Zap, Car, Settings } from "lucide-react";
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 w-full flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="w-full lg:w-1/2 py-16 lg:py-24 relative z-20">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-heading font-black text-white mb-6 leading-[1.1] tracking-tight">
