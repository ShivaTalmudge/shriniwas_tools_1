...
export default function Footer() {
  return (
    <footer className="bg-brand-dark text-white pt-12 pb-8 md:pt-20 md:pb-10">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-16">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-heading font-bold mb-4 md:mb-6 border-b border-white/10 pb-2 md:pb-4">Quick Links</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-heading font-bold mb-4 md:mb-6 border-b border-white/10 pb-2 md:pb-4">Contact Us</h4>
