        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto overflow-x-hidden">
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="w-11 h-11 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center text-gray-500 hover:text-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-accent"
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all text-sm" required placeholder="Your Name" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-700 uppercase tracking-wider">Company *</label>
                    <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all text-sm" required placeholder="Company Name" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-700 uppercase tracking-wider">Email *</label>
                    <input type="email" className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all text-sm" required placeholder="email@company.com" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-700 uppercase tracking-wider">Phone</label>
                    <input type="tel" className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all text-sm" placeholder="+91 98765 43210" />
                  </div>
                </div>
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50 rounded-b-2xl">
              ...
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <div className="flex items-center gap-4">
                  {/* WhatsApp */}
                  <a href="#" aria-label="WhatsApp" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-brand-primary shadow-sm hover:bg-brand-primary hover:text-white transition-all group">
                  ...
                  {/* LinkedIn */}
                  <a href="#" aria-label="LinkedIn" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-brand-primary shadow-sm hover:bg-brand-primary hover:text-white transition-all group">
                  ...
                  {/* Email */}
                  <a href="#" aria-label="Email" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-brand-primary shadow-sm hover:bg-brand-primary hover:text-white transition-all">
                    <Mail className="w-5 h-5" />
                  </a>
                  {/* Phone */}
                  <a href="#" aria-label="Phone" className="w-11 h-11 bg-white rounded-full flex items-center justify-center text-brand-primary shadow-sm hover:bg-brand-primary hover:text-white transition-all">
